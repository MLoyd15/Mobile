...
export default function ProductDetailScreen({ route }) {
  // Fix: Safely access route params to prevent the error
  ...
  const getImageUrl = (product) => {
    // Try imageUrl first, then images array, then fallback
    ...
    // Use toAbsoluteUrl helper if available
    if (toAbsoluteUrl) {
      return toAbsoluteUrl(imageSource);
    }
      ...
      >
        <Animated.View style={{ opacity: fadeAnim }}>
          ...
          <View style={s.productInfoCard}>
            ...
            {/* Weight Display - Only show if weightKg exists */}
            {p.weightKg && (
          ...
          <View style={s.reviewsSection}>
            <View style={s.reviewsHeader}>
              ...
              {averageRating > 0 && (
                <View style={s.averageRatingContainer}>
                  <Text style={s.averageRatingNumber}>
            ...
            <View style={s.writeReviewCard}>
              ...
              <TouchableOpacity 
                style={[
                  s.submitButton,
                  (!newRating || !newComment.trim()) && s.submitButtonDisabled
                ]}
              ...
              >
                <Text style={[
                  s.submitButtonText,
                  (!newRating || !newComment.trim()) && s.submitButtonTextDisabled
                ]}>
                  Submit Review
                </Text>
              </TouchableOpacity>
